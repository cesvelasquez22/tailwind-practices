...
/*
ng config projects.tailwind-practices.architect.build.builder @angular-builders/custom-webpack:browser
ng config projects.tailwind-practices.architect.build.options.customWebpackConfig.path webpack.config.js
ng config projects.tailwind-practices.architect.serve.builder @angular-builders/custom-webpack:dev-server
ng config projects.tailwind-practices.architect.test.builder @angular-builders/custom-webpack:browser
ng config projects.tailwind-practices.architect.test.options.customWebpackConfig.path webpack.config.js
*/